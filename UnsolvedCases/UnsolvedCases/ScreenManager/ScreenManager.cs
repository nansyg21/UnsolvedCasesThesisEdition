...
namespace UnsolvedCases
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        public static GraphicsDeviceManager graphicsManager;//gia thn allagh diastasewn othonhs thn wra tou paixnidiou
        #endregion
        ...
        public float MiddleScreenX
        {
            get { return middleScreenX; }
            set { middleScreenX = value; }
        }

        public float MiddleScreenY
        {
            get { return middleScreenY; }
            set { middleScreenY = value; }
        }
        ...
        /// </summary>
        public ScreenManager(Game game, GraphicsDeviceManager gManager)
            : base(game)
        {
            mainGame = game;
        ...
        protected override void LoadContent()
        {
            ...
            blankTexture = content.Load<Texture2D>(@"Textures\HideScreen");

            cursor = new MouseCursor(mainGame, spriteBatch); //created game, created content : create cursor
