...
namespace UnsolvedCases
{
    ...
    static class Fonts
    {
        ...
        private static SpriteFont loginFont;

        public static SpriteFont LoginFont
        {
            get { return loginFont; }
        }
        ...
        private static SpriteFont helpFont;
        ...
        public static readonly Color MainColor = new Color(27, 117, 187);
        public static readonly Color LoginColor = new Color(255, 255, 0);
        ...
        public static void LoadContent(ContentManager contentManager)
        {
            ...
            mainFont = contentManager.Load<SpriteFont>("Fonts/ComixLoud");
            loginFont = contentManager.Load<SpriteFont>("Fonts/Grinched");
            messageFont = contentManager.Load<SpriteFont>("Fonts/TimesNewRoman");
            helpFont = contentManager.Load<SpriteFont>("Fonts/BigComixLoud");
        }
